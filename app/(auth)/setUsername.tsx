      ...
      <SafeAreaView className='flex-1 bg-[#FFFFFC]'>
        ...
        <View className='flex px-6 h-min flex-col gap-y-3'>
          <TextInput value={firstName}
            onChangeText={(text) => setfirstName(text)} className=' px-5 bg-[#fafafa] rounded-2xl border-2 border-[#fafafa]/0  focus:border-2 focus:border-[#1BD868]' style={styles.input} placeholder='Име' placeholderTextColor='#0b0b0b97' />
          <TextInput value={lastName}
            onChangeText={(text) => setlastName(text)} className=' px-5 bg-[#fafafa] rounded-2xl border-2 border-[#fafafa]/0 focus:border-2 focus:border-[#1BD868]' style={styles.input} placeholder='Презиме' placeholderTextColor='#0b0b0b97' />
