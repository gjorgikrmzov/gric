import { View, Text, TextInput, Platform, StyleSheet, KeyboardAvoidingView } from 'react-native'
    ...
    <Animated.View className='flex-1 pt-4 bg-[#0b0b0b]' entering={FadeIn.springify().delay(150).duration(200)}>
      <SafeAreaView className='flex-1 bg-[#0b0b0b]'>
        ...
        <View className='flex px-6 h-min flex-col gap-y-3'>
          ...
          <PressableScale onPress={() => router.push('/signIn')} className='mt-4 ml-0.5'>
        ...
        <KeyboardAvoidingView style={{ flex: 1 }} className='justify-end' behavior='position'>
          <View className='px-6  pb-6'>
            <PressableScale onPress={setAccName} className='bg-[#121212]/90 border-2 border-[#1BD868] flex flex-row items-center self-end justify-center rounded-3xl w-1/2 py-5'>
