...
const Page = () => {
  ...
  const deliveryAddress = addresses.find((address) => address.id === orderDetails?.deliveryAddressId);
  ...
  return (
    <GestureHandlerRootView>
            ...
            <View  className="bg-[#0b0b0b] flex-1">
              ...
              <View
                style={styles.header}
                className="flex px-6  pb-5 absolute left-0 z-20  w-full "
              >
              ...
              >
                <View className="flex py-3 flex-col h-full pb-14">
                  ...
                  >
                    ...
                    <PressableScale className="bg-[#121212]/90 mt-3 px-6 w-full py-4  flex flex-row items-center justify-between">
                      <View className="flex-col items-start">
                        <View className="flex flex-row items-center">
                          ...
                          <View className="ml-1.5">
                            ...
                            >
                              {`${deliveryAddress?.street.substring(
                                0,
                                15
                              )}... `}
