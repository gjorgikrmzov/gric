      ...
      <View className="bg-[#0b0b0b] flex-1">
        <View className="flex absolute left-0 z-20  w-full ">
          ...
          <Animated.View
            ...
            className={isFocused ? "flex h-full mt-10 px-6 relative" : "hidden"}
          >
            <ScrollView
                    ...
                    >
                      <View className="w-full h-16 bg-[#0b0b0b]/5 rounded-xl mb-2">
                        <Image
                          ...
                          className="w-full z-0 h-full absolute left-0 top-0 rounded-xl rounded-bl-none rounded-br-none"
                        />
                      </View>
                      ...
                      <Text
                        style={{ fontFamily: "medium" }}
                        className="ml-2.5 mr-2.5 mb-2.5"
                      >
                        {store.name}
                      </Text>
                    </PressableScale>
                  ...
                  <PressableScale
                    className={
                      selectedStoreId === store.id
                        ...
                        : "-z-0 p-2 justify-center items-center flex rounded-2xl bg-[#fafafa]"
                    }
                  >
                    <Shop
                      size={19}
