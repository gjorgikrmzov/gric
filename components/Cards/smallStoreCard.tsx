      ...
      >
        <View className="flex overflow-hidden relative">
          {item.isOpen ? (
            ...
            <View className="bg-[#121212]/80 rounded-2xl z-[999] flex justify-center items-center w-24 h-24 p-5 absolute overflow-hidden">
              <Text
          ...
          {item.imageUrl === null ? (
            <View className="absolute h-full left-0 bg-[#121212]/90 rounded-2xl top-0  w-full "></View>
          ) : null}
          <Image
